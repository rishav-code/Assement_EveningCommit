...
public class FilePath {
	...
	public final static String TESTDATA_FILE = RESOURCES_HOME + "testdata" + File.separator + "tutorialsninja.xlsx";
	public final static String TESTDATA_FILE2 = RESOURCES_HOME + "testdata" + File.separator + "phpassessment2.xlsx";
